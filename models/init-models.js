...
function initModels(sequelize) {
  ...
  departments.belongsToMany(employees, { as: 'emp_no_employees', through: dept_manager, foreignKey: "dept_no", otherKey: "emp_no" });
  employees.belongsToMany(departments, { as: 'dept_no_departments', through: dept_manager, foreignKey: "emp_no", otherKey: "dept_no" });
